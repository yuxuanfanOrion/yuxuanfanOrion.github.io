  ...
  <div class="pub-scroll-container scroll-container">
    ...
    <div class="pub-item">
      ...
      <div class="pub-meta">
        ...
        {% if pub.paper_note %}<span class="pub-note">({{ pub.paper_note }})</span>{% endif %}
        ...
        {% if pub.dataset_url %}<a class="badge badge-link" href="{{ pub.dataset_url }}" target="_blank" rel="noopener">HuggingFace</a>{% endif %}
      </div>
    </div>
    {% endfor %}
  </div>
